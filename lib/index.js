...
function appConfig(customProcess){
  return new Promise((resolve, reject)=>{
    try {
      ...
      let env_filepath = (cli_config.envOptions && cli_config.envOptions.path) ? cli_config.envOptions.path : path.join(process.cwd(), '.env');
      ...
      if (cli_config.db_config) {
        ...
        let envOptions = (cli_config.envOptions) ? cli_config.envOptions : {};
